...
int llc(char trama[], int longitud, char *resultado){
  ...
  if((control%2)==0){
    ...
    if(trama[12]==0x00 && trama[13]<=0x03){
      ...
      /*El siguiente if nos indica el valor de p/f*/
      if((sb%2)==0){
        sb=sb/2;
      }
      else{
        /*Si el valor de p/f es 1 entonces se escribe el mensaje correspondiente
        */
        strcpy(crpf,", p (C)");
        sb=(sb-1)/2;
      }
    ...
    if((sb%2)==0){
      ...
      if(trama[12]==0x00 && trama[13]<=0x03){
        ...
        if((sb%2)==0){
          ...
          /*Si el valor de p/f es 1 entonces se escribe el mensaje
          correspondiente*/
          strcpy(crpf,", f (R)");
          sb=(sb-1)/2;
        }
      ...
      if((sb%2)==1){
        ...
        if((sb%2)==0){
          ...
          if((sb%2)==0){
            ...
            /*Como aun no sabemos de que tipo de trama se trata dejaremos una
            bandera para despues escribir el mensaje correspondiente a p/f*/
            bandera=1;
            sb=(sb-1)/2;
          }
          if((sb%2)==1){
